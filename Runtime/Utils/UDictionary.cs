...
namespace EMA.Utils
{
    ...
    /// public ExampleDictionary Dict;
    /// [Serializable]
    /// public class ExampleDictionary : UDictionary&lt;int, string&gt; { }
    /// </code>
    /// </summary>
    [Serializable]
...
public class UDictionary<TKey, TValue> : UDictionary, IDictionary<TKey, TValue>
{
    ...
    public Dictionary<TKey, TValue> ToDictionary()
    {
        ...
        for (int i = 0; i < keys.Count; i++)
        {
            ...
            {
                Debug.LogWarning($"Duplicate key found: {keys[i]}. Ignoring the duplicate entry.");
            }
        }
